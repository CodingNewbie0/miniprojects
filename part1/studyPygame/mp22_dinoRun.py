...
JUMPING = [pygame.image.load(f'./studyPyGame/Assets/Dino/DinoJump.png')]
# 구름이미지
...
class Dino: # 공룡 클래스
    X_POS = 80; Y_POS = 310; Y_POS_DUCK = 350; JUMP_VEL = 9.0
...
class Bird(Obstacle): # 새 장애물 클래스 상속클래스
