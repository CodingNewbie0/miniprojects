...
class qtApp(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        uic.loadUi('./studyPython/busstop_modify.ui', self)
        self.setWindowIcon(QIcon('./studyPython/busstopimage.png'))
    ...
    def btnBus2Clicked(self):
        if self.flag2==0:
            self.btnBus2.setStyleSheet('background-color:rgb(100,100,255)')
    ...
    def btnBus3Clicked(self):
        if self.flag3==0:
            self.btnBus3.setStyleSheet('background-color:rgb(100,100,255)')
