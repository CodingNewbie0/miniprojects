# NaverAPI 클래스 - OpnAPI 인터넷 통해서 데이터를 전달받음
...
class NaverAPI:
    ...
    def get_request_url(self, url):
        req = Request(url)
        # Naver API 개인별 인증
        req.add_header('X-Naver-Client-Id', 'lt0gsbZ4cUqny48FKZM2')
        req.add_header('X-Naver-Client-Secret', '5j62jHpdyS')
